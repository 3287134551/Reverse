...
(function () {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
        , d = d.AES = p.extend({
            mi6c: function () {
                for (var a = this.J3x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.ZE5J = d + 6) + 1), e = this.bsk5p = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            Cx0x: function (a, b, c, d, e, j, l, f) {
                for (var m = this.ZE5J, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
let i3x = '{"logs":"[{\"action\":\"bannerimpress\",\"json\":{\"adLocation\":\"\",\"adSource\":\"\",\"adid\":\"\",\"backgroundColor\":\"\",\"backgroundImageUrl\":\"\",\"encodeId\":\"\",\"exclusive\":false,\"extMonitor\":[],\"imageUrl\":\"http://p1.music.126.net/olCYkkw-fZumMC3Wu0JdRQ==/109951169290706109.jpg\",\"monitorBlackList\":[],\"monitorClick\":\"\",\"monitorClickList\":[],\"monitorImpress\":\"\",\"monitorImpressList\":[],\"monitorType\":\"\",\"scm\":\"1.music-homepage.homepage_banner_force.banner.8808982.1112662638.null\",\"targetId\":\"184129339\",\"targetType\":\"10\",\"titleColor\":\"red\",\"typeTitle\":\"新碟首发\",\"url\":\"/album?id=184129339\",\"picUrl\":\"http://p1.music.126.net/olCYkkw-fZumMC3Wu0JdRQ==/109951169290706109.jpg\",\"type\":\"10_专辑\",\"id\":\"184129339\",\"position\":\"184129339\",\"requestid\":\"undefined_1706420423031_6453\",\"impressid\":\"undefined_1706420423031_6453_1706423069045_5551\",\"mainsite\":\"1\"}}]","csrf_token":""}'
...
function j3x_bh3x(k3x, cF3x, O3x) {
    if (!k3x || !k3x.length || false)
        return this;
    if (!!k3x.forEach) {
        k3x.forEach(cF3x, O3x);
        return this
    }
    for (var i = 0, l = k3x.length; i < l; i++)
        cF3x.call(O3x, k3x[i], i, k3x);
    return this
}
;
function bsu5z(cxU3x) {
    var m3x = [];
    j3x_bh3x(cxU3x, function (cxT3x) {
        m3x.push(Xo5t[cxT3x])
    });
    return m3x.join("")
}
...
function d(i3x, A1, A2, A3) {
    var h = {}
        , i = a(16);
    return h.encText = b(i3x, A3),
        h.encText = b(h.encText, i),
        h.encSecKey = c(i, A1, A2),
        h
}
